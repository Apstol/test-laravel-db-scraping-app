...
{
    public function getIncomesGenerator(): \Generator
    {
        $currentPage = 1;
    ...
    private function buildUrl(int $page): string
    {
        ...
        $url = sprintf("%s://%s:%s/api/incomes?dateFrom=%s&dateTo=%s&page=%d&key=%s", $protocol, $host, $port, $dateFrom, $dateTo, $page, $apiKey);
